...
LOCAL_CFLAGS += -DENABLE_SINGLE_THREADED=0 -DWTF_USE_PTHREADS=1 -D__LINUX__=1 -DCOMPATIBLE_GCC4=1 -D__LITTLE_ENDIAN__=1
...
LOCAL_C_INCLUDES := $(LOCAL_C_INCLUDES) \
	...
	$(JAVASCRIPTCORE_PATH)/android  \
	$(JAVASCRIPTCORE_PATH)/android/JNIUtility
